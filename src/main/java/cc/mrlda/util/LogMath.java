...
public class LogMath {
  ...
  /**
   * 
   * @param vector a vector in log format of natural base e
   * @param normalizeFactor normalize factor in log format of natural base e
   */
  ...
  /**
   * 
   * @param vectorA a vector a in log format of natural base e
   * @param vectorB a vector b in log format of natural base e
   * @return
   */
  public static float[] addVector(float[] vectorA, float[] vectorB) {
    if (vectorA.length != vectorB.length) {
      throw new IllegalArgumentException("Dimension of two vectors does not agree with each other.");
    }
  ...
  /**
   * Add vectorB to vectorA, without create new vector, i.e., this will modify the content of
   * vectorA.
   * 
   * @param vectorA a vector A in log format of natural base e
   * @param vectorB a vector B in log format of natural base e
   */
  public static void addVectorTo(float[] vectorA, float[] vectorB) {
    if (vectorA.length != vectorB.length) {
      throw new IllegalArgumentException("Dimension of two vectors does not agree with each other.");
    }
