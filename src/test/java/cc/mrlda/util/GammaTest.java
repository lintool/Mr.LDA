...
public class GammaTest {
  ...
  public void testLogGamma() {
    assertEquals(cc.mrlda.util.Gamma.lgamma(1000000), cern.jet.stat.Gamma.logGamma(1000000),
        PRECISION_12);
    assertEquals(cc.mrlda.util.Gamma.lgamma(100000), cern.jet.stat.Gamma.logGamma(100000),
        PRECISION_12);
    assertEquals(cc.mrlda.util.Gamma.lgamma(10000), cern.jet.stat.Gamma.logGamma(10000),
        PRECISION_9);

    assertEquals(cc.mrlda.util.Gamma.lgamma(1000), cern.jet.stat.Gamma.logGamma(1000), PRECISION_12);
    assertEquals(cc.mrlda.util.Gamma.lgamma(100), cern.jet.stat.Gamma.logGamma(100), PRECISION_12);
    assertEquals(cc.mrlda.util.Gamma.lgamma(10), cern.jet.stat.Gamma.logGamma(10), PRECISION_12);

    // precision drops down accordingly when computing digamma function for small value
    assertEquals(cc.mrlda.util.Gamma.lgamma(1), cern.jet.stat.Gamma.logGamma(1), PRECISION_9);
    assertEquals(cc.mrlda.util.Gamma.lgamma(0.1), cern.jet.stat.Gamma.logGamma(0.1), PRECISION_9);
    assertEquals(cc.mrlda.util.Gamma.lgamma(0.01), cern.jet.stat.Gamma.logGamma(0.01), PRECISION_9);
    assertEquals(cc.mrlda.util.Gamma.lgamma(0.001), cern.jet.stat.Gamma.logGamma(0.001),
        PRECISION_6);
  }
  ...
  public void logGammaSpeedTest() {
    ...
    for (int i = 0; i < 99999; i++) {
      cc.mrlda.util.Gamma.lgamma(i + 1);
    }
    System.out.println(System.currentTimeMillis() - time);

    time = System.currentTimeMillis();
    for (int i = 0; i < 99999; i++) {
      cc.mrlda.util.Gamma.lanczosLGamma9(i + 1);
    }
    System.out.println(System.currentTimeMillis() - time);

    time = System.currentTimeMillis();
    for (int i = 0; i < 99999; i++) {
      cc.mrlda.util.Gamma.lanczosLGamma15(i + 1);
    }
    System.out.println(System.currentTimeMillis() - time);

    time = System.currentTimeMillis();
    for (int i = 0; i < 99999; i++) {
      cc.mrlda.util.Gamma.stirlingLGamma(i + 1);
    }
    System.out.println(System.currentTimeMillis() - time);
